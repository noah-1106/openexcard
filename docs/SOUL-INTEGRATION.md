...
**Execution Card (EC)** is a scenario-based work agreement that defines:
...
1. Check if an EC exists for this task / 检查是否有对应 EC
2. Read the EC file completely / 完整读取 EC 文件
3. Verify all dependencies are available / 确认所有依赖可用
...
3. Log any deviations for future EC updates / 记录偏差以供后续更新 EC
